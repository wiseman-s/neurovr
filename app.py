        ...
        if st.button("Run Compound Evaluation"):
            ...
            for i, p in enumerate(df_cmp.to_dict(orient="records")):
                ...
                a_html += f"""
                  ...
                  <a-text value="{p['Compound']}" align="center" position="{xpos} 2.0 -3" color="#111"></a-text>
                  <a-text value="Stroke Reduction: {p['StrokeReduction']}%" align="center" position="{xpos} 1.6 -3" color="#333"></a-text>
                """
            a_html += """
